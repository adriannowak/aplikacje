...
```sql
CREATE TABLE konto (
	numer_konta varchar(32) PRIMARY KEY,
	stan_konta float,
	data_mod timestamp,
	id_klient bigint
);
...
INSERT INTO konto VALUES ('1111111111',1000,now(),1);
INSERT INTO konto VALUES ('2222222222',2000,now(),2);

delimiter $$;

CREATE PROCEDURE wykonaj_przelew(
	IN konto_1 varchar(32),
	IN konto_2 varchar(32),
	kwota float)
BEGIN
	UPDATE konto SET stan_konta = stan_konta - kwota WHERE numer_konta = konto_1;
	UPDATE konto SET stan_konta = stan_konta + kwota WHERE numer_konta = konto_2;
END$$;

CALL wykonaj_przelew('1111111111','2222222222',50);
```
...
## Egzamin praktyczny
(Egzamin)[http://technikinformatyk.pl/e14/egzamin/praktyczny/e14-03-16-05]